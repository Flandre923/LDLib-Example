 ...
 */
public class Tutorial4Item extends Item {

    public static final Supplier<Tutorial4Item> INSTANCE = () -> new Tutorial4Item(
            new Properties()
                    .stacksTo(1)
    );

    public Tutorial4Item(Properties properties) {
        super(properties);
    }
...
//            var modularUI = Tutorial3UIContainer.createModularUI(player);
            var modularUI = Tutorial4UIContainer.createModularUI3();
